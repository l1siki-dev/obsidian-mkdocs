...
Rail's efficiency comes from the steel wheel. Monorail has a rubber tire, which is practically a car. Rubber tire is inefficient because it deforms.  
...
This is just one example of Cognitive Bias they are benefiting from. 
...
The Swiss Franc is the ultimate "Luxury Brand" of currencies.
Having a Swiss bank account or having a connection with Switzerland alone proves one's social status.
So Riches (whose most important thing is reputation) loves it and appeal they have the connection. They become unpaid ambassadors of the country.
